...
public class Patient {
	...
	public void setSymptom(String symptom) {
		this.symptom = symptom.toLowerCase();
	}
	
	
	public Patient(Long id, @Size(min = 3, message = "Name should be at least 3 characters") String name,
			@Size(max = 20, message = "City should be at most 20 characters") String city,
	...
	public String toString() {
		return "Patient [id=" + id + ", name=" + name + ", city=" + city + ", email=" + email + ", phone_number="
				+ phone_number + ", symptom=" + symptom + "]";
	}
